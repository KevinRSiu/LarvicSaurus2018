...
public class NodeNewP{
	...
	public NodeNewP(NodeNewP from, EntityID id, WorldInfo wi, Collection<EntityID> targets){
		this.id = id;
		this.alpha = 0.4; //Ambulancia
		this.beta = 0.7;  //Bomberos
		this.gamma = 0.9; //Policias
		this.ambulancias = 0.2;
		this.bomberos = 0.3;
		this.policias = 0.5;
