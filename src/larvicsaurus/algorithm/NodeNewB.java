...
public class NodeNewB{
	...
	public NodeNewB(NodeNewB from, EntityID id, WorldInfo wi, Collection<EntityID> targets){
		this.id = id;
		this.alpha = 0.5; //Ambulancia
		this.beta = 0.9;  //Bomberos
		this.gamma = 0.3; //Policias
		this.ambulancias = 0.3;
		this.bomberos = 0.2;
		this.policias = 0.5;
