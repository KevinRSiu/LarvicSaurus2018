package larvicsaurus.algorithm.clustering;
...
public class KMeansPP extends StaticClustering {
    ...
    public KMeansPP(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
