...
public class HKMeansPPFB extends StaticClustering {
    ...
    public HKMeansPPFB(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
