...
public class HKMeansAT extends StaticClustering {
    ...
    public HKMeansAT(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        super(ai, wi, si, moduleManager, developData);
        this.repeatPrecompute = 5 ; //developData.getInteger("sample.module.SampleKMeans.repeatPrecompute", 7);
    ...
    private void calcStandard(int repeat) {
        ...
        for(int index=0; index<this.clusterSizeTop; index++){
            ...
            for (int i=0; i<repeat; i++){
            	...
            	for(int jndex=0;jndex < this.clusterSizeBottom; jndex++){
            		this.clusterEntitiesList.get(index*this.clusterSizeTop+jndex).clear();
            	}
