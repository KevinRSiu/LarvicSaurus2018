...
public class WKMeansPF extends StaticClustering {
   ...
   // Double MEDIUM_HIGH = 0.75;
    ...
    public WKMeansPF(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
