...
public class PathPlanningNewDistance extends PathPlanning{
    ...
    public PathPlanningNewDistance(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
