...
public class AStarPathPlanningNewP extends PathPlanning {
    ...
    public AStarPathPlanningNewP(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
    ...
    public PathPlanning calc() {
        ...
        Map<EntityID, NodeNewP> nodeMap = new HashMap<>();
        open.add(this.from);
        nodeMap.put(this.from, new NodeNewP(null, this.from, this.worldInfo, targets));
        close.clear();
        ...
        while(true){
        	...
        	for(EntityID neighbour : neighbours){
        		NodeNewP m = new NodeNewP(n, neighbour, this.worldInfo, targets);
