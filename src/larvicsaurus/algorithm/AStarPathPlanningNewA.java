...
public class AStarPathPlanningNewA extends PathPlanning {
    ...
    public AStarPathPlanningNewA(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
    ...
    public PathPlanning calc() {
        ...
        Map<EntityID, NodeNewA> nodeMap = new HashMap<>();
        open.add(this.from);
        nodeMap.put(this.from, new NodeNewA(null, this.from, this.worldInfo, targets));
        close.clear();
        ...
        while(true){
        	...
        	for(EntityID neighbour : neighbours){
        		NodeNewA m = new NodeNewA(n, neighbour, this.worldInfo, targets);
